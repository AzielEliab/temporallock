...
<body>
  ...
  <div class="card">
    ...
    <a class="dl" href="/download?asset=temporallock-0.1.0.tar.gz">Download temporallock-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>temporallock-download-tracker</code>, project <code>temporallock</code>. Not mixed with any other *Lock.</p>
