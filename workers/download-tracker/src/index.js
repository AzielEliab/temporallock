...
const GITHUB_RELEASES = "https://github.com/AzielEliab/temporallock/releases";
...
const DOI = "https://doi.org/10.5281/zenodo.21431405";
const ZENODO = "https://zenodo.org/records/21431405";
...
async function githubStats(env) {
  ...
  const headers = { "User-Agent": "Mozilla/5.0 TemporalLock-download-tracker", Accept: "application/vnd.github+json" };
  let stars = 0;
  let forks = 0;
  let watchers = 0;
  let release_download_count = 0;
  try {
    const repoRes = await fetch("https://api.github.com/repos/AzielEliab/temporallock", { headers });
    if (repoRes.ok) {
    ...
    const relRes = await fetch("https://api.github.com/repos/AzielEliab/temporallock/releases/latest", { headers });
    if (relRes.ok) {
...
# TemporalLock one-click install. Counted download via this Worker.
set -euo pipefail
HOST="${HOST}"
ASSET="${DEFAULT_ASSET}"
...
<title>TemporalLock — Aziel Eliab</title>
<meta name="description" content="Append-only observation receipts with evidence and confidence by Aziel Eliab; receipts, not truth claims.">
<meta name="author" content="Aziel Eliab">
<link rel="canonical" href="https://temporallock-download-tracker.vibelock.workers.dev/">
<meta property="og:title" content="TemporalLock — Aziel Eliab">
<meta property="og:description" content="Append-only observation receipts with evidence and confidence by Aziel Eliab; receipts, not truth claims.">
<meta property="og:url" content="https://temporallock-download-tracker.vibelock.workers.dev/">
...
<script type="application/ld+json">
{
  ...
  "codeRepository": "https://github.com/AzielEliab/temporallock",
  "downloadUrl": "https://temporallock-download-tracker.vibelock.workers.dev/download",
  "license": "https://www.apache.org/licenses/LICENSE-2.0",
  "url": "https://temporallock-download-tracker.vibelock.workers.dev/",
  "description": "Append-only observation receipts with evidence and confidence by Aziel Eliab; receipts, not truth claims.",
  "identifier": "https://doi.org/10.5281/zenodo.21431405"
}
</script>
<!-- gitbaby-seo -->
<style>
...
<body>
  ...
  <div class="card">
    ...
    <p class="kid"><strong>Two big buttons.</strong> Download saves the gzip (the Downloads number goes up). One-click install copies a Terminal command. After it finishes, type <code>temporallock ui</code>.</p>
    <div class="btns">
      <a class="btn primary dl" href="/download?asset=${DEFAULT_ASSET}">Download</a>
      <button type="button" class="btn install" id="install-btn">One-click install</button>
    </div>
    <pre id="install-cmd">${INSTALL_LINE}</pre>
    <p class="kid">Then run: <code>temporallock ui</code> and open http://127.0.0.1:8766 (this computer only).</p>
    ...
    <script>
      (function () {
        ...
        btn.addEventListener("click", function () {
          function done(ok) {
            btn.textContent = ok ? "Copied! Paste in Terminal, then run temporallock ui" : "Select the command, copy it, then run temporallock ui";
...
<section class="cite" id="cite">
  <h2>How to cite</h2>
  <p>Aziel Eliab. TemporalLock. https://github.com/AzielEliab/temporallock. https://temporallock-download-tracker.vibelock.workers.dev. https://doi.org/10.5281/zenodo.21431405.</p>
  <p><a href="https://aziel-runtime.vibelock.workers.dev/">Catalog</a> · <a href="https://github.com/AzielEliab/temporallock">GitHub</a> · <a href="https://temporallock-download-tracker.vibelock.workers.dev/download">Download</a> · <a href="https://temporallock-download-tracker.vibelock.workers.dev/cite.json">cite.json</a></p>
</section>
<!-- /gitbaby-seo -->
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === "/cite.json" || url.pathname === "/cite.json/") && request.method === "GET") {
      return json({"author": "Aziel Eliab", "title": "TemporalLock", "github": "https://github.com/AzielEliab/temporallock", "download": "https://temporallock-download-tracker.vibelock.workers.dev/download", "doi": "10.5281/zenodo.21431405", "license": "Apache-2.0", "catalog": "https://aziel-runtime.vibelock.workers.dev/"});
    }
    // /gitbaby-seo-routes
